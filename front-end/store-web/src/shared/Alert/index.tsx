...
export const Alert: React.FC<AlertProps> = ({ children = 'Alert Text', containerClassName = '', type = 'default' }) => {
  ...
  return (
    <div className={`ttnc-alert relative flex items-center text-paragraph-base px-6 pt-4 pb-3 rounded-lg ${classes}`}>
