...
const CardCategory6: FC<CardCategory6Props> = ({ className = '', featuredImage = '.', bgSVG = explore1Svg, name, desc, color = 'bg-rose-50' }) => {
  return (
    <div
      ...
      <div>
        ...
        <div className="absolute inset-5 flex flex-col justify-between items-center">
          <div className="flex justify-center items-center">
            <NcImage alt="" src={featuredImage} containerClassName={`w-20 h-20 rounded-full overflow-hidden z-0 ${color}`} />
          </div>
