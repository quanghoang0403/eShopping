...
const A_FEATURES = [
  {
    color: "bg-red-50",
    name: "Phí giao hàng",
    desc: "Phí giao hàng chỉ từ 20.000đ cho đơn hàng nội thành Tp. Hồ Chí Minh",
  ...
  {
    color: "bg-sky-50",
    name: "Linh hoạt đổi trả",
    desc: "Đổi trả thoải mái trong 30 ngày khi bạn không hài lòng với sản phẩm",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    color: "bg-green-50",
    name: "Ship toàn quốc",
    desc: "Giao hàng nhanh chóng trên phạm vi toàn quốc",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    desc: "Hoàn tiền nếu sản phẩm không đúng như mô tả hoặc bị hỏng hóc",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
