    ...
    <Popover className="relative">
      {({ open, close }) => (
        <>
          ...
          >
            <div className="w-4 h-4 flex items-center justify-center bg-primary-500 absolute top-1.5 right-1.5 rounded-full text-[10px] leading-none text-white font-medium">
