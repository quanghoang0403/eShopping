...
import { Popover, PopoverHandler, PopoverContent, Button, Typography, Badge } from '@material-tailwind/react'
...
export default function ProfileInfoPopover(props: IProps) {
  ...
  return (
    <Popover open={openPopover} handler={setOpenPopover}>
      <PopoverHandler {...triggers}>
        <Badge content="5" className="border-2 border-white cursor-pointer">
          <div className={className} onMouseEnter={() => setOpenPopover(true)}>
            <Link href="/gio-hang">
      ...
      <PopoverContent {...triggers} className="z-50 max-w-[24rem]">
        ...
        <div className="mt-6 flex items-center gap-8 border-t border-blue-gray-50 pt-4">
          ...
          <Typography as="a" href="#" variant="small" color="gray" className="flex items-center gap-2 text-sm font-normal text-blue-gray-500">
