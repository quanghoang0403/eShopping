    ...
    <footer className="container mx-auto bg-white py-8">
      <div className="container flex px-3 py-8 ">
        <div className="w-full mx-auto flex flex-wrap">
          ...
          <div className="flex w-full lg:w-1/3 lg:justify-end lg:text mt-6 md:mt-0">
            <div className="px-3 md:px-0">
              <h3 className="text-left font-bold text-gray-900">Contact us</h3>
              <p className="py-2">Phone/Zalo: 0971 238 022</p>
              <div className="w-full flex items-center py-2 mt-0">
                <a href="https://www.facebook.com/tiemdocuchoami" className="mx-2">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"></path>
                  </svg>
                </a>
                <a href="https://www.instagram.com/tiemdocuchoami/" className="mx-2">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
