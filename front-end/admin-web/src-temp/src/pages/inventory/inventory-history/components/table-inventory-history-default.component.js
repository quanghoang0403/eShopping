    ...
    columns: [
      {
        ...
        dataIndex: "time",
        className: "table-inventory-history-text-time",
        align: "center",
        render: (_, record) => {
          return (
            <>
      ...
      },
      {
        ...
        className: "table-text-supplier-overflow table-inventory-history-text-material",
        render: (_, record) => {
          if (record?.isDeleted) {
            return (
              <div
      ...
      },
      {
        ...
        dataIndex: "sku",
        className: "table-text-supplier-overflow table-inventory-history-text-branch",
      },
      {
      ...
      },
      {
        ...
        className: "table-inventory-history-text-branch",
      },
      {
        title: pageData.table.unit,
        dataIndex: "baseUnitName",
        className: "table-inventory-history-text-unit",
      },
      {
        title: pageData.table.change,
        className: "table-inventory-history-text-change",
        render: (_, record) => {
          return record?.newQuantity - record?.oldQuantity > 0
            ? "+" + formatNumberDecimalOrInteger(record?.newQuantity - record?.oldQuantity)
            : formatNumberDecimalOrInteger(record?.newQuantity - record?.oldQuantity);
        },
      },
      {
      ...
      },
      {
        ...
        dataIndex: "action",
        className: "table-inventory-history-text-action",
        render: (_, record) => {
          return (
            <Row>
              <div
                ...
                style={{
                  ...
                  backgroundColor: record?.actionBackgroundColor,
                }}
              >
                {t(record?.action)}
              </div>
      ...
      },
      {
        ...
        dataIndex: "note",
        width: "20%",
        className: "table-inventory-history-text-note",
        render: (_, record) => {
          return (
            <div className="text-overflow-content">
              <Paragraph
                style={{ maxWidth: "inherit" }}
                placement="top"
                ellipsis={{ tooltip: handleSetTranslateForNoteColumn(record) }}
                color="#50429B"
              >
                <span>{handleSetTranslateForNoteColumn(record)}</span>
              </Paragraph>
            </div>
          );
        },
      },
      {
        ...
        dataIndex: "reference",
        className: "table-inventory-history-text-reference",
        render: (_, record) => {
          return record?.orderId ? (
            <div>
              <Link to={`/report/order/detail/${record?.orderId}`} target="_blank">
                <Paragraph
                  style={{ maxWidth: "inherit" }}
                  placement="top"
                  ellipsis={{ tooltip: `#${record.reference}` }}
                  color="#50429B"
                >
                  <a> {`#${record.reference}`}</a>
                </Paragraph>
              </Link>
            </div>
          ) : record?.purchaseOrderId ? (
            <div>
              <Link to={`/inventory/detail-purchase-order/${record?.purchaseOrderId}`} target="_blank">
                <Paragraph
                  style={{ maxWidth: "inherit" }}
                  placement="top"
                  ellipsis={{ tooltip: `#${record.reference}` }}
            ...
            <div>
              <Link to={`/shift/detail/${record?.shiftId}`} target="_blank">
                <Paragraph
                  style={{ maxWidth: "inherit" }}
                  placement="top"
                  ellipsis={{ tooltip: `#${record.reference}` }}
      ...
      },
      {
        ...
        dataIndex: "createdBy",
        className: "table-inventory-history-text-createBy",
      },
    ],
