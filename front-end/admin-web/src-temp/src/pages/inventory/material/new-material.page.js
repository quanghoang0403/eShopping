              ...
              <Col span={12}>
                ...
                >
                  <InputNumber
                    ...
                    placeholder={pageData.inventory.costPerUnitPlaceholder}
            ...
            <Col span={12}>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    pattern: /^[a-zA-Z0-9]+$/,
                    message: pageData.inventory.pleaseInputTextHere,
                  },
                ]}
              >
            ...
            <Col span={16}>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: pageData.inventory.quantityValidateMessage,
                  },
                  () => ({
                    validator(_, value) {
                ...
                className="branch-input-quantity"
                initialValue={0}
              >
                <InputNumber
          ...
          <Col xs={24} sm={24} lg={12}>
            <ActionButtonGroup
              arrayButton={[
                ...
                {
                  action: (
                    <button className="action-cancel cursor-pointer" onClick={() => onCancel()}>
                      {pageData.btnCancel}
                    </button>
                  ),
                  permission: null,
