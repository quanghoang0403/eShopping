...
import { DELAYED_TIME, MaximumNumber, tableSettings } from "constants/default.constants";
            ...
            <Col span={24}>
              <Form.Item
                ...
                rules={[
                  ...
                  () => ({
                    validator(_, value) {
                      if (value > MaximumNumber || value < 1) {
              ...
              <Row>
                <Col span={24}>
                  <FnbTable
                    ...
                    className="mt-4 material-list fnb-table-min-height"
