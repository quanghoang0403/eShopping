...
export default function BillingComponent(props) {
  ...
  const handleTransferPayment = async (method) => {
    ...
    const createBankTransferModel = {
      ...
      RedirectUrl: `${env.REACT_APP_URL}/transfer-payment`,
    ...
    return (
      <div className="package-detail">
        <Row>
          ...
          <Col span={18} className="package">
            <div className="package-option-wrapper">
              <div className="package-option-container">
                {packages?.map((p, index) => {
                  const { id, name, tax, isActive, functionGroups, isChoose, packagePricings } = p;
                      ...
                      <div className="package-option">
                        ...
                        {isActive === true ? (
                          paymentDurations?.map((duration, indexDuration) => {
                            ...
                            const costPerMonth = packagePricingInfo?.pricePerMonth?.toFixed(0);
                            const end = ` ${currency}/${pageData.month}`;
                            ...
                            return (
                              <div
                                ...
                                onClick={() => {
                                  ...
                                  setSelectedPackagePrice({ ...packagePricingInfo });
                                  onCheckBoxPackageChange(null, indexDuration);
                                }}
                              >
                                <p>
                                  <span className="price">{formatTextNumber(costPerMonth)}</span>
        ...
        <Row className="float-right row-vat">
          <Col span={24}>
            <div>
              <span className="label-vat">*Giá trên chưa bao gồm 10% thuế GTGT</span>
            </div>
            <div className="mt-16">
              <Button
                type="primary"
        ...
        <div className="package-permission-wrapper">
          {allFunctionGroups?.map((functionGroup) => {
            ...
            return (
              <div>
                <div className="package-function" style={{ marginTop: "200px" }}>
                  <p>{name}</p>
                </div>
