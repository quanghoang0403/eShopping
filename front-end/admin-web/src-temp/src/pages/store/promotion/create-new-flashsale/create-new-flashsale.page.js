      ...
      >
        <Row className="fnb-row-page-header">
          <Col xs={24} sm={24} lg={12}>
            <PageTitle className="promotion-guideline-page-title" content={pageData.form.createTitle} />
          ...
          <Col xs={24} sm={24} lg={12}>
            <ActionButtonGroup
              arrayButton={[
                {
                  action: (
                    <Button type="primary" htmlType="submit" onClick={() => setIsSubmitting(true)}>
                      {pageData.btnSave}
                    </Button>
                  ),
        ...
        <Row className="mt-3 fnb-create-flash-sale">
          <Card className="fnb-card w-100">
            ...
            {isSubmitting && selectedProductPriceIds.length < 1 && (
              <span className="fnb-error-message">{pageData.form.productValidate}</span>
            )}
            <Row className="mt-3">
        ...
        <Row className="mt-3">
          <Card className="fnb-card w-100">
            ...
            <Row className="mb-2">
              <Checkbox valuePropName="checked" noStyle onChange={(e) => setIsMinimumPurchaseAmount(e.target.checked)}>
