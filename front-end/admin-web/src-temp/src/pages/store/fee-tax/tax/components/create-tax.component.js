      ...
      <Form autoComplete="off" form={form} name="basic" onFinish={onFinish}>
        <Row>
          ...
          <Col span={24}>
            ...
            >
              <Input size="large" placeholder={pageData.enterTaxName} autoComplete="none" />
            </Form.Item>
          </Col>
        </Row>
        <Row>
            ...
            <Form.Item label={pageData.type} name={["tax", "taxTypeId"]}>
              <Radio.Group>
                <Space direction="horizontal">
                  ...
                  <Radio value={enumTaxType.ImportedTax}>{pageData.importTax}</Radio>
                </Space>
              </Radio.Group>
            </Form.Item>
          </Col>
        ...
        <Row>
          ...
          <Col span={24}>
            <Form.Item name={["tax", "description"]}>
              <TextArea size="large" rows={4} placeholder={pageData.description} />
            </Form.Item>
          </Col>
        </Row>
