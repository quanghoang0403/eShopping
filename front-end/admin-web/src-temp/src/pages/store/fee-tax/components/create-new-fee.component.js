...
import { Checkbox, Col, DatePicker, Form, Input, InputNumber, Radio, Row, Switch, Tooltip, message } from "antd";
...
import { formatTextNumber, formatTextRemoveComma, getCurrency, momentFormatDateTime } from "utils/helpers";
...
export default function AddNewFeeComponent(props) {
  ...
  const handleInputChange = (e) => {
    ...
    if (!isNaN(numericValue)) {
      const formattedValue = Math.floor(numericValue);
      form.setFieldsValue({
        fee: {
