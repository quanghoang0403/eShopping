...
import defaultImage from "assets/images/thumbnail-combo-default-img.png";
...
import { formatCurrency, formatCurrencyWithoutSuffix, getCurrency, roundNumber, formatDate } from "utils/helpers";
...
export default function ComboDetail(props) {
  ...
  const pageData = {
    ...
    productTitle: t("combo.productTitle"),
    ...
    columns: [
      {
        ...
        render: (customName) => {
          return (
            <Row align="middle">
              <Paragraph placement="top" ellipsis={{ tooltip: customName }} color="#50429B">
                {customName}
              </Paragraph>
            </Row>
          );
      ...
      },
      {
        ...
        render: (comboName) => {
          return (
            <Row align="middle">
              <Paragraph placement="top" ellipsis={{ tooltip: comboName }} color="#50429B">
                {comboName}
              </Paragraph>
            </Row>
          );
              ...
              <Row>
                ...
                <Row className="w-100">
                  <Col xs={24} lg={12}>
                    ...
                    <p className="combo-view-text">{formatDate(initData?.startDate)}</p>
                  </Col>
                  {initData?.endDate && (
                    <Col xs={24} lg={12}>
                      <h4 className="fnb-form-label material-view-lable-text-color">{pageData.endDate}</h4>
                      <p className="combo-view-text">{formatDate(initData?.endDate)}</p>
                    </Col>
                  )}
                </Row>
                <Col span={24}>
