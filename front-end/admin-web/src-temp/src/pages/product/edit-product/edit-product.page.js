...
export default function EditProductPage(props) {
  ...
  function onTopicChange(e) {
    ...
    if (e.target.checked && prices.length > 0) {
      setPrices([prices[0]]);
      let formValue = form.getFieldsValue();
      let { product } = formValue;
        ...
        {prices?.length > 1 && dataInventoryTable.length > 0 && (
          <Row>
            <Tabs
              ...
              className="w-100 inventory-tab mt-2"
              id="tab-inventory"
          ...
          <>
            ...
            <Row className="float-right mb-2">
              ...
              <Text col className="ml-3 mr-1" type="danger" strong>
                {totalCost ? formatNumberDecimalOrInteger(totalCost) : formatNumberDecimalOrInteger(totalCostInitial)}
              </Text>
                          ...
                          <Row>
                            <Col lg={5} md={6} sm={24}>
                              <Button
                                ...
                                icon={<IconBtnAdd className="icon-btn-add-topping" />}
                                className="btn-add-topping"
                                onClick={() => setIsVisibleProductToppingModal(!isVisibleProductToppingModal)}
                              >
                                {pageData.addTopping}
                              </Button>
                            </Col>
                            {productToppingSelected.length > 0 && (
                              <Col lg={18} md={18} sm={24} className="topping-text">
                                <Row onClick={() => setIsVisibleProductToppingModal(!isVisibleProductToppingModal)}>
