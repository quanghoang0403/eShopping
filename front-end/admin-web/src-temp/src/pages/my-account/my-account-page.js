...
export default function MyAccountPage(props) {
  ...
  const initTabs = [
    ...
    },
    {
      ...
      component: (
        <Card className="my-account-card">
          <SubscriptionComponent userInformation={userInformation} openPackageDetail={key && key === screens.orderPackage} />
        </Card>
      ),
    },
  ];
  const [activeScreen, setActiveScreen] = React.useState(key || screens.userInformation);
