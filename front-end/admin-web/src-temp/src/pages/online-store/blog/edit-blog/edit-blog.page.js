  ...
  const pageData = {
    ...
    generalInformation: {
      ...
      category: {
        ...
        required: true,
        blogCategoryValidateMessage: t(
          "blog.create.blogCategoryValidateMessage"
        ),
      },
    ...
    blogCategory: {
      ...
      blogCategoryNameValidateMessage: t(
        "blog.create.blogCategoryNameValidateMessage"
      ),
    ...
    messageMatchSuggestSEODescription: t(
      "blog.messageMatchSuggestSEODescription"
    ),
  };
                    ...
                    <Col span={24}>
                      ...
                      >
                        <FnbSelectSingle
                          ...
                          placeholder={
                            pageData.blogCategory.blogCategoryPlaceholder
                          }
                          allowClear
                              ...
                              <Row gutter={[16, 16]}>
                                <Col xs={24} sm={24} md={24} lg={14}>
                                  ...
                                  <TextDanger
                                    ...
                                    text={
                                      pageData.blogCategory.blogCategoryExisted
                                    }
                                  />
                                </Col>
                  ...
                  <Row>
                    <Col span={24}>
                      ...
                      <div className="edit-blog-overview">
                        <a
                          style={{ fontSize: "18px" }}
                          href={`${reduxState?.session?.informationPublishStore
                            ?.domainName
                            }/blog/${!urlLink
                              ? convertSeoUrl(blogName)
                              : convertSeoUrl(urlLink)
                            }`}
                          target="_blank"
                          rel="noreferrer"
                        >
                  ...
                  <Col xs={24} sm={24} md={24} lg={24}>
                    <Card className="w-100 fnb-card h-auto">
                      ...
                      <FnbImageSelectComponent
                        ...
                        bestDisplayImage={pageData.bestDisplayImage}
                      />
                    </Card>
                  </Col>
                </Row>
