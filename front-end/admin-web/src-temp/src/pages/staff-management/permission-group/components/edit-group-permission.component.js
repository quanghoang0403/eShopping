...
export default function EditGroupPermission(props) {
  ...
  const allowedPermissionIdsOnlineStore = [PermissionKeys.VIEW_THEME_STORE.toLowerCase(), PermissionKeys.EDIT_THEME.toLowerCase(), PermissionKeys.REMOVE_THEME.toLowerCase()];
            ...
            <Row style={{ marginBottom: "8px" }}>
              <Col span={24}>
                ...
                <Form.Item
                  name="name"
                  rules={[
                    { required: true, message: pageData.nameGroupPermissionValidate },
