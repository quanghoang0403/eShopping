...
const RegisterPage = (props) => {
  ...
  const onCountryChange = (countryId) => {
    ...
    const currency = currencies?.filter((item) => item.code === country?.currencycode);
  ...
  const onFinish = () => {
    form.validateFields().then((values) => {
      storeDataService.registerNewStoreAccountAsync(values).then((res) => {
        if (res) {
          if (isDefaultCountry) setCurrentStep(EnumRegisterStep.CompleteRegisterLocal);
          if (!isDefaultCountry) setCurrentStep(EnumRegisterStep.CompleteRegisterOtherCountry);
        }
      });
    });
  };
  ...
  const next = () => {
    switch (currentStep) {
      case EnumRegisterStep.StoreInfo:
        form.validateFields(["storeName", "countryId", "currencyId", "businessAreaId", "langCode"]).then(() => {
      ...
      case EnumRegisterStep.AddressInfo:
        if (isDefaultCountry) {
          form.validateFields(["address1", "cityId", "districtId", "wardId"]).then(() => {
        ...
        <>
          ...
          <div className="login-contain login-contain__right">
            <div className="login-inner login-inner__spacing">
              <Form form={form} onFinish={onFinish} className="form-register form-register__spacing" autoComplete="off">
                {/* Step line icon */}
                {((currentStep <= EnumRegisterStep.AddressInfo && isDefaultCountry) ||
                ...
                <div className="form-container">
                  ...
                  {currentStep === EnumRegisterStep.StoreInfo && (
                    <>
                      ...
                      <h4 className="label-register  mt-24">{pageData.storeName}*</h4>
                      <Form.Item
                        name="storeName"
                        rules={[
                          {
                      ...
                      <Row>
                        <Col span={12} className="mt-8">
                          <h4 className="label-register ">{pageData.country}*</h4>
                          <Form.Item name="countryId" rules={[{ required: true }]}>
                            <FnbSelectRegister
                              ...
                              placeholder={
                                <>
                                  ...
                                  <span className="ml-2"> {pageData.select} </span>
                                </>
                              }
                              labelOption={<WorldIcon className="icon-select-dropdown" />}
                        ...
                        <Col span={12} className="mt-8">
                          <h4 className="label-register ml-16">{pageData.currency}*</h4>
                          <Form.Item
                            name="currencyId"
                            rules={[
                              {
                          ...
                          >
                            <FnbSelectRegister
                              ...
                              labelOption={<DollarIcon className="icon-select-dropdown" />}
                      ...
                      <h4 className="label-register mt-8">{pageData.businessModel}*</h4>
                      <Form.Item
                        name="businessAreaId"
                        rules={[
                          {
                        ...
                        <FnbSelectRegister
                          ...
                          placeholder={
                            <>
                              ...
                              <span className="ml-2"> {pageData.selectBusinessModel}</span>
                            </>
                          }
                          labelOption={<DrinkBeerIcon className="icon-select-dropdown" />}
                  ...
                  {currentStep === EnumRegisterStep.YourInfo && (
                    <>
                      ...
                      <h4 className="label-register mt-24">{pageData.fullName}*</h4>
                      <Form.Item
                        name="fullName"
                        rules={[
                          {
                    ...
                    <>
                      {isDefaultCountry ? (
                        <>
                          ...
                          <h4 className="label-register  mt-24">{pageData.address}*</h4>
                          <Form.Item
                            name="address1"
                            rules={[
                              {
                          ...
                          <Row>
                            <Col span={24} className="mt-8">
                              <h4 className="label-register ">{pageData.province}</h4>
                              <Form.Item
                                name="cityId"
                                rules={[
                                  {
                          ...
                          <Row>
                            <Col span={12} className="mt-8">
                              <h4 className="label-register ">{pageData.district}</h4>
                              <Form.Item
                                name="districtId"
                                rules={[
                                  {
                            ...
                            <Col span={12} className="mt-8">
                              <h4 className="label-register ml-16">{pageData.ward}</h4>
                              <Form.Item
                                name="wardId"
                                rules={[
                                  {
                        ...
                        <>
                          ...
                          <Row>
                            <Col span={24} className="mt-8">
                              <h4 className="label-register  ">{pageData.addressTwo}*</h4>
                              <Form.Item
                                name="address2"
                                rules={[
                                  {
                          ...
                          <Row>
                            <Col span={24} className="mt-8">
                              <h4 className="label-register "> {pageData.city}</h4>
                              <Form.Item
                                name="cityTown"
                                rules={[
                                  {
                  ...
                  {currentStep === EnumRegisterStep.AddressInfoOtherCountry && !isDefaultCountry && (
                    <>
                      <h1 className="header">{pageData.yourAddress}</h1>
                      <h4 className="label-register  mt-24">{pageData.state}</h4>
                        ...
                        <FnbSelectRegister
                          ...
                          placeholder={
                            <>
                              ...
                              <span className="ml-2"> {pageData.selectProvince}</span>
                            </>
                          }
                          labelOption={<PinIcon className="icon-select-dropdown-2" />}
                ...
                <>
                  ...
                  {((currentStep === EnumRegisterStep.CompleteRegisterOtherCountry && !isDefaultCountry) ||
                    (currentStep === EnumRegisterStep.CompleteRegisterLocal && isDefaultCountry)) && (
                    <>
                ...
                <div className="bottom-content">
                  {currentStep === EnumRegisterStep.StoreInfo && (
                    <Row>
                      ...
                      <Col span={12} className="mt-8">
                        <Button className="button-next ml-8" type="primary" onClick={() => next()}>
              ...
              {((currentStep === EnumRegisterStep.OtpVerificationOtherCountry && !isDefaultCountry) ||
                ...
                <Row>
                  ...
                  {((currentStep === EnumRegisterStep.CompleteRegisterOtherCountry && !isDefaultCountry) ||
                    (currentStep === EnumRegisterStep.CompleteRegisterLocal && isDefaultCountry)) && (
                    <Button className="button-start button-next  mt-8" type="primary">
                ...
                <div>
                  ...
                  {isDefaultCountry ? (
                    <>
                      ...
                      ></Form.Item>
                      <Form.Item name="cityId" hidden="true" rules={[{ required: true }]}></Form.Item>
                      <Form.Item
                        name="districtId"
                        hidden="true"
