  ...
  return (
    <>
      <Form form={form} name="basic" autoComplete="off">
        <Collapse
          defaultActiveKey="3"
          className="fnb-collapse content-email-campaign"
          onChange={onChangeCollapse}
          activeKey={showContent && "3"}
        >
          <Collapse.Panel key={3} header={<div>{translateData.content}</div>} forceRender={true}>
            <Collapse defaultActiveKey="3.1" className="fnb-collapse content-article content-main-article">
              <Collapse.Panel key={3.1} header={translateData.mainArticle} forceRender={true}>
            ...
            <Collapse defaultActiveKey="3.2" className="fnb-collapse content-article content-sub-article">
              <Collapse.Panel key={3.2} header={translateData.subArticles} forceRender={true}>
