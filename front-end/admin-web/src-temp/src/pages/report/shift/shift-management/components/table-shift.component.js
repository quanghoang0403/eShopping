...
import { formatCurrency, formatDate, getCurrency, hasPermission } from "utils/helpers";
import "../index.scss";
const { Option } = Select;
...
export default function TableShift(props) {
            ...
            <>
              ...
              <Row>
                ...
                <Col span={12} className="mt-1">
                  <span>{record?.checkIn && formatDate(record?.checkIn, DateFormat.HH_MM)}</span>
                </Col>
              </Row>
              <Row>
                <Col span={12}>
                ...
                <Col span={12} className="mt-1">
                  <span>{record?.checkOut && formatDate(record?.checkOut, DateFormat.HH_MM)}</span>
                </Col>
              </Row>
            </>
          );
  ...
  const fetchDatableAsync = async (pageNumber, pageSize, date, branchId) => {
    const response = await shiftDataService.getShiftsAsync(date, branchId, pageNumber, pageSize);
        ...
        <Row>
          <Col span={5}>
            <Card className="border-div">
              ...
              <Row className="text-align-center">
                <h1 className="shift-value">{shiftData?.orderValue} </h1>
              </Row>
              <Row className="text-align-center">
          ...
          <Col span={5}>
            <Card className="border-div">
              ...
              <br />
              <Row className="text-align-center">
                <h1 className="shift-value">{shiftData?.soldProductValue}</h1>
              </Row>
              <Row className="text-align-center">
          ...
          <Col span={5}>
            <Card className="border-div">
              ...
              <Row className="text-align-center">
                <h1 className="shift-value">{formatCurrency(shiftData?.totalDiscountValue)}</h1>
              </Row>
              <Row className="text-align-center">
          ...
          <Col span={5}>
            <Card className="border-div">
              ...
              <Row className="text-align-center"> {"(".concat(getCurrency()).concat(")")}</Row>
              <Row className="text-align-center">
                <h1 className="shift-value">{formatCurrency(shiftData?.revenueValue)}</h1>
              </Row>
              <Row className="text-align-center">
