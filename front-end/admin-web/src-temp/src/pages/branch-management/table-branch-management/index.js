        ...
        return (
          <div>
            <div className="text-name text-overflow">
              <TooltipParagraph className="text-color-name">{record.name}</TooltipParagraph>
            </div>
            <div className="text-addressInfo text-overflow">
              <TooltipParagraph className="text-color-address">{record.addressInfo}</TooltipParagraph>
            </div>
          </div>
        );
      },
