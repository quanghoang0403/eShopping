...
export function TopSellingProductComponent(props) {
  let { dataSource, title, hideSeeMore, onScroll } = props;
  ...
  return (
    <>
      ...
      >
        ...
        <div className="top-selling-product-scroll mt-5">
          <div className="cc-wrapper cc-wrapper--scroll top-product-modal-table" onScroll={onScroll}>
