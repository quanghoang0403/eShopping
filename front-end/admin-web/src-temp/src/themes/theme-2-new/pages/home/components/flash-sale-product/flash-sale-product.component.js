      ...
      {product && (
        <a href={`./product-detail/${product?.id}`}>
          <div className="flash-sale-product">
            <div className="image">
              <div className="percent-label">-{calculatePercentage(product?.sellingPrice, product?.originalPrice)}</div>
                  ...
                  <>
                    {product?.remainingQuantity > 0 ? (
                      <>
                        ...
                        <div className="quantity-bar-number">{product?.remainingQuantity}</div>
                      </>
                    ) : (
