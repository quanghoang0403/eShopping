  ...
  return (
    <Layout className="order" style={{ fontFamily: fontFamily }}>
      ...
      <BoxDrawer
        ...
        title={
          <div className="content-center" style={{ fontFamily: fontFamily }}>
            {t("order.callWaiter")}
          </div>
        }
        height={"auto"}
      ...
      <BoxDrawer
        ...
        title={
          <div className="content-center history-label" style={{ fontFamily: fontFamily }}>
            {t("order.history")}
          </div>
        }
        height={"100%"}
        ...
        body={<OrderActionHistories open={isOpenHistoryBox} fontFamily={fontFamily} />}
        style={{ fontFamily: fontFamily }}
      />
    </Layout>
  );
