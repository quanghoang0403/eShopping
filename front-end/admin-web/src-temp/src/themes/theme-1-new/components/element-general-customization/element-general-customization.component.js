...
import "./element-general-customization.component.scss";

const { Panel } = Collapse;

// THEME COMPONENT
export function ElementCustomizationCollapseBlock({
  icon,
  title,
  className,
  content: Component,
          ...
          header={
            <Row gutter={[24, 24]}>
              ...
              <Col sm={20} lg={20} className="w-100">
                <div className="header-collapse" onClick={onClickHeader}>
                  {renderTitle()}
                </div>
              </Col>
            </Row>
