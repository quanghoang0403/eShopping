...
import './shop-select-multiple-product-render-option.scss'
/**
...
export function FnbSelectMultipleProductRenderOption (props) {
  ...
  return (
    <Select
      ...
      onSelect={onSelect}
      style={style}
      className={`shop-select-multiple-product-with-group ${className}`}
      popupClassName="shop-select-multiple-product-with-group-dropdown"
