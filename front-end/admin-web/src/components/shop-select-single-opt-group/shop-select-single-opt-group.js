...
import './shop-select-single-opt-group.scss'
  ...
  return (
    <>
      <Select
        ...
        onSelect={onSelect}
        style={style}
        className={`shop-select-single-opt-group ${className}`}
        popupClassName={`shop-select-single-opt-group-dropdown ${popupClassName}`}
