...
export interface SocialsListHorizontalProps {
  className?: string
  itemClass?: string
}
...
const SocialsListHorizontal: FC<SocialsListHorizontalProps> = ({ className = '', itemClass = 'block w-6 h-6' }) => {
  return (
...
export default SocialsListHorizontal
