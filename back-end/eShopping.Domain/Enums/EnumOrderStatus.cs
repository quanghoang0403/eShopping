namespace eShopping.Domain.Enums
{
    ...
    //    {
    //        EnumOrderStatus.New => "posOrder.detail.new",
    //        EnumOrderStatus.Returned => "posOrder.detail.returned",
    //        EnumOrderStatus.Canceled => "posOrder.detail.canceled",
    //        EnumOrderStatus.ToConfirm => "posOrder.detail.toConfirm",
    //        EnumOrderStatus.Processing => "posOrder.detail.processing",
    //        EnumOrderStatus.Delivering => "posOrder.detail.delivering",
    //        EnumOrderStatus.Completed => "posOrder.detail.completed",
    //        EnumOrderStatus.Draft => "posOrder.detail.draft",
    //        _ => string.Empty
    //    };
    //}
}
