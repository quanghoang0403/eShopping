...
{
    public class CheckBranchesExpirationTimeJob : ICheckBranchesExpirationTimeJob
    {
        public const string JOB_NAME = nameof(CheckBranchesExpirationTimeJob);
        ...
        public CheckBranchesExpirationTimeJob(ILogger<CheckBranchesExpirationTimeJob> logger, IHttpClientFactory httpClientFactory, IOptions<GlobalAppSetting> globalAppSettingOpt, IServiceManagement serviceManagement)
        {
            _logger = logger;
        ...
        public void Execute(params object[] args)
        {
            try
            {
                ...
                var result = httpClient.GetAsync(jobSetting.EndPoint).GetAwaiter().GetResult();
