...
{
    public class ResetAccumulatedPointJob : IResetAccumulatedPointJob
    {
        public const string JOB_NAME = nameof(ResetAccumulatedPointJob);

        private readonly ILogger<ResetAccumulatedPointJob> _logger;
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly GlobalAppSetting _globalAppSetting;
        private readonly IServiceManagement _serviceManagement;

        public ResetAccumulatedPointJob(ILogger<ResetAccumulatedPointJob> logger, IHttpClientFactory httpClientFactory, IOptions<GlobalAppSetting> globalAppSettingOpt, IServiceManagement serviceManagement)
        {
            _logger = logger;
