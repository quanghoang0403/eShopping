...
{
    public class SendEmailCampaignJob : ISendEmailCampaignJob
    {
        public const string JOB_NAME = nameof(SendEmailCampaignJob);

        private readonly ILogger<SendEmailCampaignJob> _logger;
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly GlobalAppSetting _globalAppSetting;
        private readonly IServiceManagement _serviceManagement;

        public SendEmailCampaignJob(ILogger<SendEmailCampaignJob> logger, IHttpClientFactory httpClientFactory, IOptions<GlobalAppSetting> globalAppSettingOpt, IServiceManagement serviceManagement)
        {
            _logger = logger;
