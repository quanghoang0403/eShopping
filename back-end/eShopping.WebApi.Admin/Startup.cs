using Amazon.S3;
using eShopping.Application.Admin;
using eShopping.Application.Admin.Mappings;
using eShopping.Application.Admin.Middlewares;
using eShopping.Application.Admin.Providers;
...
namespace eShopping.WebApi.Admin
{
