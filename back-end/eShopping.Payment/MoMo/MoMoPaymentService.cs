...
namespace eShopping.Payment.MoMo
{
    ...
    public class MoMoPaymentService : IMoMoPaymentService
    {
        ...
        public Task<CreateGetwayResponseModel> CreateGatewayAsync(CreateGetwayRequestModel request, string requestType)
        {
            ...
            if (requestType.Equals(RequestTypes.CaptureWallet) || requestType.Equals(RequestTypes.CreditCard))
            {
        ...
        /// <returns></returns>
        public async Task<MomoWrapperResponse<MomoPaymentResponse>> CreatePosGatewayAsync(CreatePosGatewayRequest request)
        {
            ...
            var publicKey = _momoSettings.PublicKey;
            ...
            string signature = momoSecurity.SignSHA256(rawSignature, _momoSettings.SecretKey);
        ...
        public Task<QueryStatusResponseModel> QueryStatusAsync(QueryStatusRequestModel request)
        {
        ...
        public Task<string> CreateDynamicQRCodeContentAsync(CreateDynamicQRCodeModel request)
        {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public Task<CreateRefundResponse> CreateRefundAsync(CreateRefundRequest request)
        {
        ...
        public async Task<AuthenticatedCheckResponseModel> AuthenticatedCheckAsync(AuthenticatedCheckRequestModel request, LoggedUserModel loggedUser)
        {
            ...
            try
            {
                var createGateway = await CreateGatewayTestingAsync(requestGateway);
